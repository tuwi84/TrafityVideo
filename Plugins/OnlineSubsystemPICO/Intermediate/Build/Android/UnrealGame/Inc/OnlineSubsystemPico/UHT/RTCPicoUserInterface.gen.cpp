...
// End Cross Module References
	...
	static UEnum* ERtcPrivilege_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERtcPrivilege.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OnlineSubsystemPico_ERtcPrivilege, Z_Construct_UPackage__Script_OnlineSubsystemPico(), TEXT("ERtcPrivilege"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OnlineSubsystemPico_ERtcPrivilege_Statics::EnumParams = {
		...
		METADATA_PARAMS(Z_Construct_UEnum_OnlineSubsystemPico_ERtcPrivilege_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_OnlineSubsystemPico_ERtcPrivilege_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ERtcEngineInitResult_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERtcEngineInitResult.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OnlineSubsystemPico_ERtcEngineInitResult, Z_Construct_UPackage__Script_OnlineSubsystemPico(), TEXT("ERtcEngineInitResult"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OnlineSubsystemPico_ERtcEngineInitResult_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_OnlineSubsystemPico_ERtcEngineInitResult_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_OnlineSubsystemPico_ERtcEngineInitResult_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ERtcRoomProfileType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERtcRoomProfileType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OnlineSubsystemPico_ERtcRoomProfileType, Z_Construct_UPackage__Script_OnlineSubsystemPico(), TEXT("ERtcRoomProfileType"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OnlineSubsystemPico_ERtcRoomProfileType_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_OnlineSubsystemPico_ERtcRoomProfileType_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_OnlineSubsystemPico_ERtcRoomProfileType_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ERtcMuteState_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERtcMuteState.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OnlineSubsystemPico_ERtcMuteState, Z_Construct_UPackage__Script_OnlineSubsystemPico(), TEXT("ERtcMuteState"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OnlineSubsystemPico_ERtcMuteState_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_OnlineSubsystemPico_ERtcMuteState_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_OnlineSubsystemPico_ERtcMuteState_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ERtcPauseResumeMediaType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERtcPauseResumeMediaType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OnlineSubsystemPico_ERtcPauseResumeMediaType, Z_Construct_UPackage__Script_OnlineSubsystemPico(), TEXT("ERtcPauseResumeMediaType"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OnlineSubsystemPico_ERtcPauseResumeMediaType_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_OnlineSubsystemPico_ERtcPauseResumeMediaType_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_OnlineSubsystemPico_ERtcPauseResumeMediaType_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ERtcAudioPlaybackDevice_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERtcAudioPlaybackDevice.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OnlineSubsystemPico_ERtcAudioPlaybackDevice, Z_Construct_UPackage__Script_OnlineSubsystemPico(), TEXT("ERtcAudioPlaybackDevice"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OnlineSubsystemPico_ERtcAudioPlaybackDevice_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_OnlineSubsystemPico_ERtcAudioPlaybackDevice_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_OnlineSubsystemPico_ERtcAudioPlaybackDevice_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ERtcAudioScenarioType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERtcAudioScenarioType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OnlineSubsystemPico_ERtcAudioScenarioType, Z_Construct_UPackage__Script_OnlineSubsystemPico(), TEXT("ERtcAudioScenarioType"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OnlineSubsystemPico_ERtcAudioScenarioType_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_OnlineSubsystemPico_ERtcAudioScenarioType_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_OnlineSubsystemPico_ERtcAudioScenarioType_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ERtcStreamIndex_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERtcStreamIndex.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OnlineSubsystemPico_ERtcStreamIndex, Z_Construct_UPackage__Script_OnlineSubsystemPico(), TEXT("ERtcStreamIndex"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OnlineSubsystemPico_ERtcStreamIndex_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_OnlineSubsystemPico_ERtcStreamIndex_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_OnlineSubsystemPico_ERtcStreamIndex_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ERtcEarMonitorMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERtcEarMonitorMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OnlineSubsystemPico_ERtcEarMonitorMode, Z_Construct_UPackage__Script_OnlineSubsystemPico(), TEXT("ERtcEarMonitorMode"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OnlineSubsystemPico_ERtcEarMonitorMode_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_OnlineSubsystemPico_ERtcEarMonitorMode_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_OnlineSubsystemPico_ERtcEarMonitorMode_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ERtcJoinRoomType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERtcJoinRoomType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OnlineSubsystemPico_ERtcJoinRoomType, Z_Construct_UPackage__Script_OnlineSubsystemPico(), TEXT("ERtcJoinRoomType"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OnlineSubsystemPico_ERtcJoinRoomType_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_OnlineSubsystemPico_ERtcJoinRoomType_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_OnlineSubsystemPico_ERtcJoinRoomType_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ERtcUserLeaveReasonType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERtcUserLeaveReasonType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OnlineSubsystemPico_ERtcUserLeaveReasonType, Z_Construct_UPackage__Script_OnlineSubsystemPico(), TEXT("ERtcUserLeaveReasonType"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OnlineSubsystemPico_ERtcUserLeaveReasonType_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_OnlineSubsystemPico_ERtcUserLeaveReasonType_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_OnlineSubsystemPico_ERtcUserLeaveReasonType_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ERtcMediaDeviceType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERtcMediaDeviceType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OnlineSubsystemPico_ERtcMediaDeviceType, Z_Construct_UPackage__Script_OnlineSubsystemPico(), TEXT("ERtcMediaDeviceType"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OnlineSubsystemPico_ERtcMediaDeviceType_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_OnlineSubsystemPico_ERtcMediaDeviceType_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_OnlineSubsystemPico_ERtcMediaDeviceType_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ERtcMediaDeviceState_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERtcMediaDeviceState.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OnlineSubsystemPico_ERtcMediaDeviceState, Z_Construct_UPackage__Script_OnlineSubsystemPico(), TEXT("ERtcMediaDeviceState"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OnlineSubsystemPico_ERtcMediaDeviceState_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_OnlineSubsystemPico_ERtcMediaDeviceState_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_OnlineSubsystemPico_ERtcMediaDeviceState_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ERtcMediaDeviceError_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERtcMediaDeviceError.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OnlineSubsystemPico_ERtcMediaDeviceError, Z_Construct_UPackage__Script_OnlineSubsystemPico(), TEXT("ERtcMediaDeviceError"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OnlineSubsystemPico_ERtcMediaDeviceError_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_OnlineSubsystemPico_ERtcMediaDeviceError_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_OnlineSubsystemPico_ERtcMediaDeviceError_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ERtcSyncInfoStreamType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERtcSyncInfoStreamType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OnlineSubsystemPico_ERtcSyncInfoStreamType, Z_Construct_UPackage__Script_OnlineSubsystemPico(), TEXT("ERtcSyncInfoStreamType"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OnlineSubsystemPico_ERtcSyncInfoStreamType_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_OnlineSubsystemPico_ERtcSyncInfoStreamType_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_OnlineSubsystemPico_ERtcSyncInfoStreamType_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ERtcMediaStreamType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERtcMediaStreamType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OnlineSubsystemPico_ERtcMediaStreamType, Z_Construct_UPackage__Script_OnlineSubsystemPico(), TEXT("ERtcMediaStreamType"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OnlineSubsystemPico_ERtcMediaStreamType_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_OnlineSubsystemPico_ERtcMediaStreamType_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_OnlineSubsystemPico_ERtcMediaStreamType_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* ERtcStreamRemoveReason_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERtcStreamRemoveReason.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OnlineSubsystemPico_ERtcStreamRemoveReason, Z_Construct_UPackage__Script_OnlineSubsystemPico(), TEXT("ERtcStreamRemoveReason"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OnlineSubsystemPico_ERtcStreamRemoveReason_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_OnlineSubsystemPico_ERtcStreamRemoveReason_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_OnlineSubsystemPico_ERtcStreamRemoveReason_Statics::Enum_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_VR_VrVideoUpdateWS_Plugins_OnlineSubsystemPICO_Source_OnlineSubsystemPico_Public_RTCPicoUserInterface_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_VR_VrVideoUpdateWS_Plugins_OnlineSubsystemPICO_Source_OnlineSubsystemPico_Public_RTCPicoUserInterface_h_Statics::EnumInfo[] = {
		{ ERtcPrivilege_StaticEnum, TEXT("ERtcPrivilege"), &Z_Registration_Info_UEnum_ERtcPrivilege, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 384653258U) },
		{ ERtcEngineInitResult_StaticEnum, TEXT("ERtcEngineInitResult"), &Z_Registration_Info_UEnum_ERtcEngineInitResult, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4064891423U) },
		{ ERtcRoomProfileType_StaticEnum, TEXT("ERtcRoomProfileType"), &Z_Registration_Info_UEnum_ERtcRoomProfileType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2361685647U) },
		{ ERtcMuteState_StaticEnum, TEXT("ERtcMuteState"), &Z_Registration_Info_UEnum_ERtcMuteState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1445447277U) },
		{ ERtcPauseResumeMediaType_StaticEnum, TEXT("ERtcPauseResumeMediaType"), &Z_Registration_Info_UEnum_ERtcPauseResumeMediaType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 49750238U) },
		{ ERtcAudioPlaybackDevice_StaticEnum, TEXT("ERtcAudioPlaybackDevice"), &Z_Registration_Info_UEnum_ERtcAudioPlaybackDevice, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 31716213U) },
		{ ERtcAudioScenarioType_StaticEnum, TEXT("ERtcAudioScenarioType"), &Z_Registration_Info_UEnum_ERtcAudioScenarioType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 837401261U) },
		{ ERtcStreamIndex_StaticEnum, TEXT("ERtcStreamIndex"), &Z_Registration_Info_UEnum_ERtcStreamIndex, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1918558845U) },
		{ ERtcEarMonitorMode_StaticEnum, TEXT("ERtcEarMonitorMode"), &Z_Registration_Info_UEnum_ERtcEarMonitorMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3377681713U) },
		{ ERtcJoinRoomType_StaticEnum, TEXT("ERtcJoinRoomType"), &Z_Registration_Info_UEnum_ERtcJoinRoomType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 959837942U) },
		{ ERtcUserLeaveReasonType_StaticEnum, TEXT("ERtcUserLeaveReasonType"), &Z_Registration_Info_UEnum_ERtcUserLeaveReasonType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2693022707U) },
		{ ERtcMediaDeviceType_StaticEnum, TEXT("ERtcMediaDeviceType"), &Z_Registration_Info_UEnum_ERtcMediaDeviceType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4023325939U) },
		{ ERtcMediaDeviceState_StaticEnum, TEXT("ERtcMediaDeviceState"), &Z_Registration_Info_UEnum_ERtcMediaDeviceState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3523282993U) },
		{ ERtcMediaDeviceError_StaticEnum, TEXT("ERtcMediaDeviceError"), &Z_Registration_Info_UEnum_ERtcMediaDeviceError, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3969811412U) },
		{ ERtcSyncInfoStreamType_StaticEnum, TEXT("ERtcSyncInfoStreamType"), &Z_Registration_Info_UEnum_ERtcSyncInfoStreamType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1560655467U) },
		{ ERtcMediaStreamType_StaticEnum, TEXT("ERtcMediaStreamType"), &Z_Registration_Info_UEnum_ERtcMediaStreamType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1644417197U) },
		{ ERtcStreamRemoveReason_StaticEnum, TEXT("ERtcStreamRemoveReason"), &Z_Registration_Info_UEnum_ERtcStreamRemoveReason, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 993436763U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_VR_VrVideoUpdateWS_Plugins_OnlineSubsystemPICO_Source_OnlineSubsystemPico_Public_RTCPicoUserInterface_h_3818984605(TEXT("/Script/OnlineSubsystemPico"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_VR_VrVideoUpdateWS_Plugins_OnlineSubsystemPICO_Source_OnlineSubsystemPico_Public_RTCPicoUserInterface_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_VR_VrVideoUpdateWS_Plugins_OnlineSubsystemPICO_Source_OnlineSubsystemPico_Public_RTCPicoUserInterface_h_Statics::EnumInfo));
