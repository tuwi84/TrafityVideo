...
public:
	...
	bool bAdaptiveResolutionEnabled;
	EPICOXRAdaptiveResolutionPowerSetting AdaptiveResolutionPowerSetting;
...
public:
	...
	void EnableAdaptiveResolution(bool bEnable);

	bool IsAdaptiveResolutionEnabled() const;
