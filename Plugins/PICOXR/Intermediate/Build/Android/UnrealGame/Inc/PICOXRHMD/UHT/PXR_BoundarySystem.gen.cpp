...
// End Cross Module References
	...
	struct Z_CompiledInDeferFile_FID_VR_VrVideoUpdateWS_Plugins_PICOXR_Source_PICOXRHMD_Private_PXR_BoundarySystem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_VR_VrVideoUpdateWS_Plugins_PICOXR_Source_PICOXRHMD_Private_PXR_BoundarySystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPICOXRBoundarySystem, UPICOXRBoundarySystem::StaticClass, TEXT("UPICOXRBoundarySystem"), &Z_Registration_Info_UClass_UPICOXRBoundarySystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPICOXRBoundarySystem), 3832009940U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_VR_VrVideoUpdateWS_Plugins_PICOXR_Source_PICOXRHMD_Private_PXR_BoundarySystem_h_460700609(TEXT("/Script/PICOXRHMD"),
		Z_CompiledInDeferFile_FID_VR_VrVideoUpdateWS_Plugins_PICOXR_Source_PICOXRHMD_Private_PXR_BoundarySystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_VR_VrVideoUpdateWS_Plugins_PICOXR_Source_PICOXRHMD_Private_PXR_BoundarySystem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
