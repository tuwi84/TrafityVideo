...
// IWYU pragma: private, include "PXR_MRTypes.h"
...
#define FID_VR_VrVideoUpdateWS_Plugins_PICOXR_Source_PICOXRMR_Public_PXR_MRTypes_h_129_GENERATED_BODY \
...
#define FID_VR_VrVideoUpdateWS_Plugins_PICOXR_Source_PICOXRMR_Public_PXR_MRTypes_h_175_GENERATED_BODY \
...
#define FID_VR_VrVideoUpdateWS_Plugins_PICOXR_Source_PICOXRMR_Public_PXR_MRTypes_h_264_GENERATED_BODY \
...
#define FID_VR_VrVideoUpdateWS_Plugins_PICOXR_Source_PICOXRMR_Public_PXR_MRTypes_h_276_GENERATED_BODY \
...
#define FID_VR_VrVideoUpdateWS_Plugins_PICOXR_Source_PICOXRMR_Public_PXR_MRTypes_h_288_GENERATED_BODY \
...
#define FID_VR_VrVideoUpdateWS_Plugins_PICOXR_Source_PICOXRMR_Public_PXR_MRTypes_h_300_GENERATED_BODY \
...
#define FID_VR_VrVideoUpdateWS_Plugins_PICOXR_Source_PICOXRMR_Public_PXR_MRTypes_h_351_GENERATED_BODY \
...
#define CURRENT_FILE_ID FID_VR_VrVideoUpdateWS_Plugins_PICOXR_Source_PICOXRMR_Public_PXR_MRTypes_h
...
template<> struct TIsUEnumClass<EPICOResult> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EPICOSpatialTrackingState> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EPICOSpatialTrackingStateMessage> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EPICOAnchorComponentTypeFlag> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EPICOSpatialSceneDataTypeFlags> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EPICOAnchorSceneLabel> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EPICOPersistLocation> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EPICOLoadFilterType> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<EPICOSpatialSceneCaptureStatus> { enum { Value = true }; };
