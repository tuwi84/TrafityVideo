...
class UScriptStruct* FPxrAudioSpatializerReverbPluginSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PxrAudioSpatializerReverbPluginSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPxrAudioSpatializerReverbPluginSettings, Z_Construct_UPackage__Script_PicoSpatialAudio(), TEXT("PxrAudioSpatializerReverbPluginSettings"));
	}
...
template<> PICOSPATIALAUDIO_API UScriptStruct* StaticStruct<FPxrAudioSpatializerReverbPluginSettings>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPxrAudioSpatializerReverbPluginPreset_SetSettings_Statics::NewProp_InSettings = { "InSettings", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(PxrAudioSpatializerReverbPluginPreset_eventSetSettings_Parms, InSettings), Z_Construct_UScriptStruct_FPxrAudioSpatializerReverbPluginSettings, METADATA_PARAMS(Z_Construct_UFunction_UPxrAudioSpatializerReverbPluginPreset_SetSettings_Statics::NewProp_InSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UPxrAudioSpatializerReverbPluginPreset_SetSettings_Statics::NewProp_InSettings_MetaData)) }; // 2396804875
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UPxrAudioSpatializerReverbPluginPreset_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UPxrAudioSpatializerReverbPluginPreset_SetSettings, "SetSettings" }, // 4003322867
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPxrAudioSpatializerReverbPluginPreset_Statics::NewProp_Settings = { "Settings", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UPxrAudioSpatializerReverbPluginPreset, Settings), Z_Construct_UScriptStruct_FPxrAudioSpatializerReverbPluginSettings, METADATA_PARAMS(Z_Construct_UClass_UPxrAudioSpatializerReverbPluginPreset_Statics::NewProp_Settings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPxrAudioSpatializerReverbPluginPreset_Statics::NewProp_Settings_MetaData)) }; // 2396804875
	...
	struct Z_CompiledInDeferFile_FID_VR_VrVideoUpdateWS_Plugins_PicoSpatialAudio_Source_PicoSpatialAudio_Private_PxrAudioSpatializerReverb_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_VR_VrVideoUpdateWS_Plugins_PicoSpatialAudio_Source_PicoSpatialAudio_Private_PxrAudioSpatializerReverb_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_VR_VrVideoUpdateWS_Plugins_PicoSpatialAudio_Source_PicoSpatialAudio_Private_PxrAudioSpatializerReverb_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPxrAudioSpatializerReverbPluginPreset, UPxrAudioSpatializerReverbPluginPreset::StaticClass, TEXT("UPxrAudioSpatializerReverbPluginPreset"), &Z_Registration_Info_UClass_UPxrAudioSpatializerReverbPluginPreset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPxrAudioSpatializerReverbPluginPreset), 1335205483U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_VR_VrVideoUpdateWS_Plugins_PicoSpatialAudio_Source_PicoSpatialAudio_Private_PxrAudioSpatializerReverb_h_4130772502(TEXT("/Script/PicoSpatialAudio"),
		Z_CompiledInDeferFile_FID_VR_VrVideoUpdateWS_Plugins_PicoSpatialAudio_Source_PicoSpatialAudio_Private_PxrAudioSpatializerReverb_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_VR_VrVideoUpdateWS_Plugins_PicoSpatialAudio_Source_PicoSpatialAudio_Private_PxrAudioSpatializerReverb_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_VR_VrVideoUpdateWS_Plugins_PicoSpatialAudio_Source_PicoSpatialAudio_Private_PxrAudioSpatializerReverb_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_VR_VrVideoUpdateWS_Plugins_PicoSpatialAudio_Source_PicoSpatialAudio_Private_PxrAudioSpatializerReverb_h_Statics::ScriptStructInfo),
		nullptr, 0);
