...
// End Cross Module References
	...
	static UEnum* EPxrAudioSpatializer_RenderingMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EPxrAudioSpatializer_RenderingMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PicoSpatialAudio_EPxrAudioSpatializer_RenderingMode, Z_Construct_UPackage__Script_PicoSpatialAudio(), TEXT("EPxrAudioSpatializer_RenderingMode"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PicoSpatialAudio_EPxrAudioSpatializer_RenderingMode_Statics::EnumParams = {
		...
		METADATA_PARAMS(Z_Construct_UEnum_PicoSpatialAudio_EPxrAudioSpatializer_RenderingMode_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_PicoSpatialAudio_EPxrAudioSpatializer_RenderingMode_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* EPxrAudioSpatializer_SourceAttenuationMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EPxrAudioSpatializer_SourceAttenuationMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PicoSpatialAudio_EPxrAudioSpatializer_SourceAttenuationMode, Z_Construct_UPackage__Script_PicoSpatialAudio(), TEXT("EPxrAudioSpatializer_SourceAttenuationMode"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PicoSpatialAudio_EPxrAudioSpatializer_SourceAttenuationMode_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_PicoSpatialAudio_EPxrAudioSpatializer_SourceAttenuationMode_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_PicoSpatialAudio_EPxrAudioSpatializer_SourceAttenuationMode_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* EPxrAudioSpatializer_SceneMaterialPreset_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EPxrAudioSpatializer_SceneMaterialPreset.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PicoSpatialAudio_EPxrAudioSpatializer_SceneMaterialPreset, Z_Construct_UPackage__Script_PicoSpatialAudio(), TEXT("EPxrAudioSpatializer_SceneMaterialPreset"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PicoSpatialAudio_EPxrAudioSpatializer_SceneMaterialPreset_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_PicoSpatialAudio_EPxrAudioSpatializer_SceneMaterialPreset_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_PicoSpatialAudio_EPxrAudioSpatializer_SceneMaterialPreset_Statics::Enum_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_VR_VrVideoUpdateWS_Plugins_PicoSpatialAudio_Source_PicoSpatialAudio_Private_PicoSpatialAudioEnums_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_VR_VrVideoUpdateWS_Plugins_PicoSpatialAudio_Source_PicoSpatialAudio_Private_PicoSpatialAudioEnums_h_Statics::EnumInfo[] = {
		{ EPxrAudioSpatializer_RenderingMode_StaticEnum, TEXT("EPxrAudioSpatializer_RenderingMode"), &Z_Registration_Info_UEnum_EPxrAudioSpatializer_RenderingMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 580408331U) },
		{ EPxrAudioSpatializer_SourceAttenuationMode_StaticEnum, TEXT("EPxrAudioSpatializer_SourceAttenuationMode"), &Z_Registration_Info_UEnum_EPxrAudioSpatializer_SourceAttenuationMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3913749492U) },
		{ EPxrAudioSpatializer_SceneMaterialPreset_StaticEnum, TEXT("EPxrAudioSpatializer_SceneMaterialPreset"), &Z_Registration_Info_UEnum_EPxrAudioSpatializer_SceneMaterialPreset, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4008255086U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_VR_VrVideoUpdateWS_Plugins_PicoSpatialAudio_Source_PicoSpatialAudio_Private_PicoSpatialAudioEnums_h_3519935058(TEXT("/Script/PicoSpatialAudio"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_VR_VrVideoUpdateWS_Plugins_PicoSpatialAudio_Source_PicoSpatialAudio_Private_PicoSpatialAudioEnums_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_VR_VrVideoUpdateWS_Plugins_PicoSpatialAudio_Source_PicoSpatialAudio_Private_PicoSpatialAudioEnums_h_Statics::EnumInfo));
